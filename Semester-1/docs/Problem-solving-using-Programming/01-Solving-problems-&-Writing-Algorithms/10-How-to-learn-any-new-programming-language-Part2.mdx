...
**Problem 4:**
Draw the following spiral using loops
...
Draw 20 squares all with one vertex at home position 
...
**Problem 6:** 
Draw the following circular spiral with a random pen colour and pen size as 2.
